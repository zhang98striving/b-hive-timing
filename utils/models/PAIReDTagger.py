...
class PAIReDTagger(nn.Module):
    n_cpf = 128
    n_sv = 10
    datasetClass = PAIReDDataset
    #optimizerClass = Ranger #not working!
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PAIReDTagger, self).__init__(**kwargs)
    ...
    #@profile
    def forward(self, cpf_features, cpf_4v, sv_features, sv_4v, kd=False): #NOTE: 4v: (batch_size, seq_len, 4); features: (batch_size, seq_len, feature_dim)
    ...
    def train_model(
        ...
        **kwargs,
        ...
        if self.optimizer_name == 'ranger':
            ...
            optimizer = PAIReDTagger.optimizerClass(self.parameters(), lr=learning_rate)
        else:
    ...
    #@profile
    def predict_model(self, dataloader, device=None, attack=None):
        print("*** Predicting ***")
        self.eval()
        ...
        return predictions, truths, None, processes
    ...
    def update(
        ...
        with Progress(
            ...
            for (                                                                    #NOTE: here the order of Dataset need to be considered
                cpf_features,
                sv_features,
                cpf_vectors,
                sv_vectors,
                ...
                weight,
                process,
            ) in dataloader:                                                          #NOTE: give features to the model, consider the order of the forward calling
