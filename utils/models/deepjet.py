...
class DeepJet(Classifier, nn.Module):
    ...
    def predict_model(self, dataloader, device, attack=None):
        ...
        for (
            ...
            with torch.no_grad():
                pred = self(global_features, cpf_features, npf_features, vtx_features)
            ...
            glob_list.append(global_features.cpu().numpy())
        ...
        np.save(
            "/net/scratch_cms3a/ajung/b-hive/InferenceTask/mod_offline_run3/part_2024_train_small/part_2024_test_small/nominal_mod/MoDJet/epochs_50/nominal/test_attack_minimizer/test_epsilon_0.001/test_iterations_10/cpf_adv.npy",
            np.concatenate(cpf_list),
        )
        np.save(
            "/net/scratch_cms3a/ajung/b-hive/InferenceTask/mod_offline_run3/part_2024_train_small/part_2024_test_small/nominal_mod/MoDJet/epochs_50/nominal/test_attack_minimizer/test_epsilon_0.001/test_iterations_10/npf_adv.npy",
            np.concatenate(npf_list),
        )
        np.save(
